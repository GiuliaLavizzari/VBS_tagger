/*
 * taken from here:
 * https://github.com/russ-ai/HepMCAnalyser/blob/master/include/utils.hh
 */
...
inline bool isUp (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 2;
}
		 
inline bool isDown (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 1;
}

inline bool isCharm (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 4;
}
		 
inline bool isStrange (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 3;
}

inline bool isTop (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 6;
}
		 
inline bool isBottom (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 5;
}

inline bool isElectron (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 11;
}

inline bool isMuon (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 13;
}

inline bool isTau (HepMC3::ConstGenParticlePtr p ){
  return abs(p->pdg_id()) == 15;
}

inline bool isLepton( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 11 || abs(p->pdg_id()) == 13 || abs(p->pdg_id()) == 15;
}

inline bool isNeutrino(HepMC3::ConstGenParticlePtr p){
  return abs(p->pdg_id()) == 12 || abs(p->pdg_id()) == 14 || abs(p->pdg_id()) == 16;
}

inline bool isGluon( HepMC3::ConstGenParticlePtr p ) {
  return p->pdg_id() == 21;
}

inline bool isPhoton( HepMC3::ConstGenParticlePtr p ) {
  return p->pdg_id() == 22;
}

inline bool isZ( HepMC3::ConstGenParticlePtr p ) {
  return p->pdg_id() == 23;
}

inline bool isW( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 24;
}

inline bool isHiggs( HepMC3::ConstGenParticlePtr p ) {
  return p->pdg_id() == 25;
}

//@TODO: Zprime,Wprime,Zprimeprime,H0,A0,H+

inline bool isChargedPion( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 211;
}

inline bool isChargino1( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 1000024;
}

inline bool isNeutralino2( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 1000023;
}

inline bool isNeutralino1( HepMC3::ConstGenParticlePtr p ) {
  return abs(p->pdg_id()) == 1000022;
}

//no way to access beams by status code (4 and 11 appear)
//but only beams have px = py = 0
inline bool isBeam( HepMC3::ConstGenParticlePtr p ) {
  return p->status() == 4 || (p->momentum().py() == 0 && p->momentum().py() == 0);
}

// returns true if the GenParticle does not decay
inline bool isFinal( HepMC3::ConstGenParticlePtr p ) {
  return !p->end_vertex() && p->status()==1;
}

// //returns true if the GenParticle is about to decay (no more showering)
// inline bool isLast( HepMC3::ConstGenParticlePtr p ) {
//   if ( p->end_vertex() ) {
//     for ( HepMC3::GenVertex::particle_iterator desc = p->end_vertex()->particles_begin(HepMC3::descendants);
// 	  desc != p->end_vertex()-> particles_end(HepMC3::descendants); 
// 	  ++desc ) {
...
// inline bool isFirst(HepMC3::ConstGenParticlePtr p){
//   if ( p->production_vertex() ) {
//     for ( HepMC3::GenVertex::particle_iterator mother = p->production_vertex()->particles_begin(HepMC3::parents);
// 	  mother != p->production_vertex()-> particles_end(HepMC3::parents); 
// 	  ++mother ) {
...
// inline bool notFromShower( HepMC3::ConstGenParticlePtr p ) {
//   if ( p->production_vertex() ) {
//     int nmoth=0;
//     for ( HepMC3::GenVertex::particle_iterator mother = p->production_vertex()->particles_begin(HepMC3::parents);
// 	  mother != p->production_vertex()-> particles_end(HepMC3::parents); 
...
// inline bool fromMeson( HepMC3::ConstGenParticlePtr p ) {
//   if ( p->production_vertex() ) {
//     for ( HepMC3::GenVertex::particle_iterator mother = p->production_vertex()->particles_begin(HepMC3::parents);
// 	  mother != p->production_vertex()-> particles_end(HepMC3::parents); 
// 	  ++mother ) {
...
inline bool iso1Meson(HepMC3::ConstGenParticlePtr p){
...
inline bool iso0Meson(HepMC3::ConstGenParticlePtr p){
...
inline bool strangeMeson(HepMC3::ConstGenParticlePtr p){
...
inline bool charmedMeson(HepMC3::ConstGenParticlePtr p){
...
inline bool bottomMeson(HepMC3::ConstGenParticlePtr p){
...
inline bool ccMeson(HepMC3::ConstGenParticlePtr p){
...
inline bool bbMeson(HepMC3::ConstGenParticlePtr p){
...
inline bool isMeson(HepMC3::ConstGenParticlePtr p){
  return iso1Meson(p) ||
    iso0Meson(p) ||
    strangeMeson(p) ||
    charmedMeson(p) ||
...
inline bool lightBaryon(HepMC3::ConstGenParticlePtr p){
...
inline bool strangeBaryon(HepMC3::ConstGenParticlePtr p){
  return abs(p->pdg_id()) >= 3000 && abs(p->pdg_id()) < 4000;
}

inline bool charmedBaryon(HepMC3::ConstGenParticlePtr p){
  return abs(p->pdg_id()) >= 4000 && abs(p->pdg_id()) < 5000;
}

inline bool bottomBaryon(HepMC3::ConstGenParticlePtr p){
  return abs(p->pdg_id()) >= 5000 && abs(p->pdg_id()) < 6000;
}

inline bool isBaryon(HepMC3::ConstGenParticlePtr p){
...
inline bool isHadron(HepMC3::ConstGenParticlePtr p){
  return isMeson(p) || isBaryon(p);
}

inline bool isBHadron(HepMC3::ConstGenParticlePtr p){
  return bottomMeson(p) || bbMeson(p) || bottomBaryon(p);
}

inline bool isVisible(HepMC3::ConstGenParticlePtr p){
